  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center gap-5 overflow-hidden px-4 pb-2 pt-6">
      ...
      (relatedArtists[current.artist_id]?.length ?? 0) > 0 ? (
        <div
          className="-my-4 w-full max-w-[22rem]"
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="relative flex flex-1 flex-col justify-between gap-2 overflow-hidden p-3">
        ...
        <div className="relative z-10 w-full">
          <h2
            className="line-clamp-1 text-xl font-semibold text-white drop-shadow-sm"
            style={{
              fontFamily:
      ...
      {song.spotify_track_id ? (
        <a
          ...
          onPointerDown={(e) => e.stopPropagation()}
          draggable={false}
          className="absolute bottom-3 right-3 z-20 flex size-10 items-center justify-center rounded-full border-2 border-emerald-500 bg-transparent text-emerald-600 transition hover:bg-emerald-500/10 active:bg-emerald-500/20 dark:text-emerald-400"
