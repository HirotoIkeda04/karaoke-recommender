...
export function RelatedArtistsLink({
  ...
  return (
    <Link
      ...
      className="flex h-9 w-full items-center rounded-full bg-zinc-100 px-3 text-zinc-500 shadow-sm transition hover:bg-zinc-200 active:scale-[0.99] active:bg-zinc-300 dark:bg-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-700"
