    ...
    <Wrapper>
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="flex items-center gap-2">
          ...
          {noteChip ? (
            <span
              className="-mr-1 shrink-0 px-1.5 py-px text-[10px] font-semibold tabular-nums tracking-[-0.04em]"
              style={{
                backgroundColor: noteChip.background,
                color: noteChip.foreground,
                // TL TR BR BL = 1.8px 1.8px 1.8px 2.4px
                borderRadius: "1.8px 1.8px 1.8px 2.4px",
              }}
